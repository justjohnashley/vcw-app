...
public class CustomerPage extends AppCompatActivity {
    ...
    private boolean validatePassword() {
        ...
        if (password.isEmpty()) {
            ...
            binding.password.setBackgroundResource(R.drawable.border_error);
            binding.password.setError("Password must contain be 8 characters long and at least 2 uppercase letters, 2 lowercase letters, 2 digits, and 1 special character.");
            return false;
        } else {
    ...
    private void showPhoneNumberDialog() {
        ...
        submitButton.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(phoneNumber) || !isValidPhoneNumber(phoneNumber)) {
                Toast.makeText(CustomerPage.this, "Enter a valid phone number. +63 123 456 789", Toast.LENGTH_SHORT).show();
                return;
            }
        ...
        PhoneAuthOptions options = PhoneAuthOptions.newBuilder(mAuth)
                ...
                .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onVerificationFailed(FirebaseException e) {
                        Toast.makeText(CustomerPage.this, "OTP Verification Failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    ...
                    public void onCodeSent(String verificationId, PhoneAuthProvider.ForceResendingToken token) {
                        ...
                        CustomerPage.this.verificationId = verificationId;
                        Toast.makeText(CustomerPage.this, "OTP Sent to " + phoneNumber, Toast.LENGTH_SHORT).show();
    ...
    private void verifyOtp(String otp, String phoneNumber) {
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                ...
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    @Override
                    public void onVerificationFailed(FirebaseException e) {
                        Toast.makeText(CustomerPage.this, "OTP verification failed.", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onCodeSent(String verificationId, PhoneAuthProvider.ForceResendingToken token) {
                        super.onCodeSent(verificationId, token);
                        CustomerPage.this.verificationId = verificationId;  // Save verificationId for later verification
                    }
                });
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful() && !task.getResult().isEmpty()) {
                        ...
                        if (email != null) {
                            ...
                            Toast.makeText(CustomerPage.this, "Email not found for this user.", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(CustomerPage.this, "No user found with this phone number.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
